...
REQUIRED={
'BK-COM-10-0001':('{{c1::株式}}','{{c1::返済義務}}','{{c1::有限責任}}'),'BK-COM-10-0002':('正味財産額＝{{c1::資産}}－{{c1::負債}}',),'BK-COM-10-0007':('（貸）{{c1::資本金}}',),'BK-COM-10-0008':('{{c1::1/2以上}}','{{c1::資本準備金}}'),'BK-COM-10-0009':('（借）{{c1::別段預金}}／（貸）{{c1::株式申込証拠金}}',),'BK-COM-10-0010':('（貸）{{c1::別段預金}}','（借）{{c1::株式申込証拠金}}','{{c1::資本準備金}}'),'BK-COM-10-0011':('{{c1::創立費}}','{{c1::開業費}}','{{c1::株式交付費}}'),'BK-COM-10-0013':('{{c1::元手}}','{{c1::利益剰余金}}','{{c1::不可}}'),'BK-COM-10-0014':('{{c1::資本金}}','{{c1::繰越利益剰余金}}'),'BK-COM-10-0015':('（借）{{c1::繰越利益剰余金}}／（貸）{{c1::損益}}',),'BK-COM-10-0017':('（借）{{c1::資本金}}／（貸）{{c1::繰越利益剰余金}}',),'BK-COM-10-0019':('配当金総額＝{{c1::1株当たり配当額}}×{{c1::発行済株式総数}}',),'BK-COM-10-0020':('（借）{{c1::繰越利益剰余金}}／（貸）{{c1::未払配当金}}','（借）{{c1::未払配当金}}／（貸）当座預金等'),'BK-COM-10-0021':('{{c1::利益準備金}}',),'BK-COM-10-0023':('（借）その他資本剰余金／（貸）{{c1::未払配当金}}・{{c1::資本準備金}}',),'BK-COM-10-0024':('必要準備金積立額＝min（{{c1::配当金}}×{{c1::1/10}}, {{c1::資本金}}×{{c1::1/4}}－{{c1::既存準備金合計}}）',),'BK-COM-10-0025':('利益準備金積立額＝{{c1::必要準備金}}×{{c1::利益剰余金財源額}}÷{{c1::配当金総額}}',),'BK-COM-10-0027':('合併時の{{c1::時価}}','（貸）{{c1::現金}}','（貸）{{c1::資本金}}'),'BK-COM-10-0028':('受入純資産額＝{{c1::受入資産時価}}－{{c1::受入負債時価}}',),'BK-COM-10-0029':('のれん＝{{c1::合併対価}}－{{c1::受入純資産額}}',),'BK-COM-10-0030':('{{c1::無形固定資産}}','{{c1::20年}}','{{c1::のれん償却}}'),'BK-COM-10-0031':('（貸）{{c1::負ののれん発生益}}','{{c1::収益}}')}
