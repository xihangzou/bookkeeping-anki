...
REQUIRED = {
    ...
    "BK-IND-08-0009": ("月末仕掛品直接材料費＝当月直接材料費×{{c1::月末仕掛品数量}}÷{{c1::当月投入数量}}",),
    "BK-IND-08-0010": ("月末仕掛品加工費＝当月加工費×{{c1::月末仕掛品加工換算量}}÷{{c1::当月投入加工換算量}}",),
    ...
    "BK-IND-08-0027": ("終点投入なら{{c1::完成品}}のみ", "加工進捗度が{{c1::投入点以上}}", "平均投入なら{{c1::加工換算量}}"),
}
