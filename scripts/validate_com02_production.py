#!/usr/bin/env python3
"""Validate COM-02 after ANKI-AUDIT-008 recall-precision audit."""
...
def main() -> int:
    ...
    if errors:
        print("COM-02 ANKI-AUDIT-008 validation: FAIL", file=sys.stderr)
        for e in errors: print(f"- {e}", file=sys.stderr)
        return 1
    print("COM-02 ANKI-AUDIT-008 validation: PASS")
    print("notes=17 cards=17 cloze_spans=50 included_alps=32 unmapped=0")
    print("journal_account_level_cloze=pass broad_cloze_precision=pass visible_answer_leakage=0")
    return 0
